...
export default async function verifyEmail(req: Request, res: Response, next: NextFunction) {
    try {
        ...
        req.body.queryResult = {msg: "<h1 style='color:green;text-align:center'>Successfully verified email</h1><p style='text-align:center'>You can now close this window.</p>", code: 200}
    }
    catch (err) {
