...
friendsRouter.post("/accept-request", acceptFriendRequest, (req: Request, res: Response) => {
    const {queryResult} = req.body
    res.status(queryResult.code)
    delete queryResult.code
    res.json({...queryResult})
...
friendsRouter.post("/decline-request", declineFriendRequest, (req: Request, res: Response) => {
    const {queryResult} = req.body
    res.status(queryResult.code)
    delete queryResult.code
    res.json({...queryResult})
